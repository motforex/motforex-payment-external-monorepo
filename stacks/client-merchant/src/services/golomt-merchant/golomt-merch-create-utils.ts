...
import { createGolomtMerchInvoice, GolomtCreateInvoiceSchema } from '@motforex/global-services';
import {
  MerchantInvoice,
...
async function createInvoiceForDeposit(
  ...
  const merchantInvoiceData = MerchantInvoiceSchema.parse({
    id,
    referenceId: id,
    referenceType: 'DEPOSIT',
    providerId: invoice,
    providerInfo: transactionId,
  ...
  const merchantInvoice = await createMerchantInvoice(merchantInvoiceData);
